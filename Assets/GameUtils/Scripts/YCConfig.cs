            ...
            public void DisplayImportConfigDialog(bool succeeded, InfosData infos, string msg = "") {
                ...
                if (succeeded && infos.name != "") {
                    ...
                    if (infos.android_key != "") {
                        ...
                        if (this.IsFromYsocorp(infos.android_key, BuildTargetGroup.Android)) {
                    ...
                    if (infos.ios_bundle_id != "") {
                        ...
                        if (this.IsFromYsocorp(infos.ios_bundle_id, BuildTargetGroup.iOS)) {
...
#if UNITY_EDITOR
            private bool IsFromYsocorp(string key, BuildTargetGroup platform) {
                return key.IndexOf("com.YsoCorp.", StringComparison.OrdinalIgnoreCase) >= 0 || PlayerSettings.GetApplicationIdentifier(platform).IndexOf("com.YsoCorp.", StringComparison.OrdinalIgnoreCase) >= 0;
            }
#endif
